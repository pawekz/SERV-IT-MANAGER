...
export default function NewRepair() {
    ...
    return (
        <div className="container mx-auto py-8 px-4 max-w-4xl">
            ...
            <svg
                className="w-4 h-4 lg:w-5 lg:h-5 text-[#33e407] dark:text-[#33e407]"
                aria-hidden="true"
            ...
            >
                ...
                >
                  <svg className={`w-4 h-4 lg:w-5 lg:h-5 ${cameFromCheckIn ? "text-[#33e407] dark:text-[#33e407]" : "text-gray-500 dark:text-gray-100"}`}
                       aria-hidden="true"
                       xmlns="http://www.w3.org/2000/svg"
                       fill="currentColor"
                       viewBox="0 0 18 20">
