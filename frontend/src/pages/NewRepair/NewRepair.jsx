    ...
    return (
        <div className="container mx-auto py-8 px-4 max-w-4xl">
            ...
            <ol className="flex justify-center items-center w-full max-w-xl mx-auto ml-56">
                ...
                {/* Step 2 - Highlight if cameFromCheckIn is true */}
                <li
                    className={`flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-4 after:inline-block ${
                        cameFromCheckIn
                            ? "text-[#33e407] dark:text-[#33e407] after:border-[#33e407]/20 dark:after:border-[#33e407]/40"
                ...
                >
                  <span
                      className={`flex items-center justify-center w-10 h-10 rounded-full lg:h-12 lg:w-12 shrink-0 ${
                          cameFromCheckIn
                              ? "bg-[#33e407]/20 dark:bg-[#33e407]/30 text-[#33e407]"
                              : "bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-100"
                      }`}
                  >
                    <svg
                        className={`w-4 h-4 lg:w-5 lg:h-5 ${
                            cameFromCheckIn ? "text-[#33e407] dark:text-[#33e407]" : "text-gray-500 dark:text-gray-100"
                        }`}
                        aria-hidden="true"
