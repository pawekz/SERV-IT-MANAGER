  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm relative">
      ...
      <div className="h-[252px] relative overflow-hidden">
        ...
        >
          {loading ? (
            <div className="text-center text-gray-500 py-8 h-full flex items-center justify-center">Loading documents...</div>
          ) : error ? (
            <div className="text-center text-red-500 py-8 h-full flex items-center justify-center">{typeof error === 'string' ? error : 'Failed to load documents'}</div>
          ) : tickets.length === 0 ? (
            <div className="text-center text-gray-600 py-8 h-full flex items-center justify-center">No documents available.</div>
          ) : (
            <>
              {tickets.map((t) => (
