    ...
    return (
        ...
        >
            <div className="max-w-2xl w-full text-center">
                ...
                {/* 404 Error Code */}
                <div className="mb-8">
                    <div className="text-9xl font-bold text-[#25D482] mb-2">401</div>
                </div>

                {/* Description Text */}
                <div className="mb-12">
                    <p className="text-gray-800 font-semibold mb-2">WE'RE SORRY BUT YOU ARE NOT AUTHORIZED FOR</p>
                    <p className="text-gray-700 text-sm">THE SELECTED ACTION</p>
                </div>
