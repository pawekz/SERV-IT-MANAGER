        ...
        <div className="space-y-6">
            ...
            <div className="bg-yellow-50 p-4 rounded-md">
                ...
                <div className="text-sm text-yellow-700 space-y-1">
                    <p><strong>Linux/Unix:</strong> <code>/var/backups/servit</code> or <code>/home/user/backups</code></p>
                    <p><strong>Windows:</strong> <code>C:\Backups\SERVIT</code> or <code>D:\Data\Backups</code></p>
                    <p><strong>Relative:</strong> <code>./backups</code> or <code>../storage/backups</code></p>
                </div>
            </div>
        </div>
    );
